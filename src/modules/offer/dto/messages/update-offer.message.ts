type messageType = 'name' | 'description' | 'city' | 'premium' | 'housingType'
    | 'roomCount' | 'guestCount' | 'cost' | 'facilities' | 'coordinates' | 'images' | 'previewImage';

export const UpdateOfferMessage: Record<messageType, string[]> = {
  ...
  previewImage: ['Preview path is required.'],
  images: ['Field images must be an array.', 'Image path should be string.']
};
